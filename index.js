...
verticals.forEach((row, rowIndex) => {
  row.forEach((open, columnIndex) => {
    ...
    const wall = Bodies.rectangle(x, y, 1, unitLength, { isStatic: true });
    World.add(world, wall);
  });
});
...
const goal = Bodies.rectangle(width - unitLength / 2, height - unitLength / 2, unitLength * 0.7, unitLength * 0.7, { label: 'goal', isStatic: true });
